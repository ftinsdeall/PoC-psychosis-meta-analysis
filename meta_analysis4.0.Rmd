...
Can't calculate power for analysis as sex as a moderator because it is not a study level variable. Therefore violates the assuming one effect size per study assumption that I have taken when doing power calculation 
